# 此项目为 https://github.com/miiot/micam   的一个go版本,提供了一个非ffmpeg实现,以下是原作者的readme信息,只需要替换掉Micam 部分的镜像(crpi-eld81eydx76recug.cn-chengdu.personal.cr.aliyuncs.com/pubsan/micam-go:latest)即可.
